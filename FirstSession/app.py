...
# Add an image or logo if desired
# st.image("your_image_url.jpg", use_column_width=True)  # Uncomment and replace with your image URL

# Ask the user for a sport-related item or activity with a nicer input box
...
# Check if the inputs are filled and display the result with a nice font
